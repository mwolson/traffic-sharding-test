...
it "had no socket errors or failed requests"
...
it "occasionally retried on downed shards"

expect_nginx_routing_summary; to_match "200 127.0.0.1:[0-9]+, 127.0.0.1:[0-9]+"
